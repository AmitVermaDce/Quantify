...
from quantify.llm_clients.api_key_env import get_api_key_env
from quantify.llm_clients.model_catalog import get_model_options
...
def ensure_api_key(provider: str) -> Optional[str]:
    ...
    # Atomic file creation to prevent symlink attacks
