...
from quantify.agents.schemas import PortfolioDecision, PortfolioRating
from quantify.graph.reflection import Reflector
...
class TestLegacyRemoval:
    ...
    def test_financial_situation_memory_removed(self):
        ...
        import quantify.agents.utils.memory as m
